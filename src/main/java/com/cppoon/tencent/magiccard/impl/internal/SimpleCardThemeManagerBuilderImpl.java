...
public class SimpleCardThemeManagerBuilderImpl implements CardThemeManager.Builder {
	...
	/* (non-Javadoc)
	 * @see com.cppoon.tencent.magiccard.CardThemeManager.Builder#name(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.cppoon.tencent.magiccard.CardThemeManager.Builder#difficulty(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.cppoon.tencent.magiccard.CardThemeManager.Builder#publishTime(java.util.Date)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.cppoon.tencent.magiccard.CardThemeManager.Builder#time(java.util.Date)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.cppoon.tencent.magiccard.CardThemeManager.Builder#expiryTime(java.util.Date)
	 */
	@Override
...
//		ret.setPrize(this.p);	// TODO implemen this
		ret.setPublishTime(this.publishTime);
//		ret.setScore(this.sc);	// TODO implement this
