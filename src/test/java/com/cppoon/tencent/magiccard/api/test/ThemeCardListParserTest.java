...
public class ThemeCardListParserTest {
	...
	public void test() {
		...
		assertEquals("prize", 100, cardTheme.getPrize());
		assertEquals("score", 200, cardTheme.getScore());
		...
		assertTrue("enabled", cardTheme.isEnabled());
		assertEquals("prize", 888, cardTheme.getPrize());
		assertEquals("score", 888, cardTheme.getScore());
